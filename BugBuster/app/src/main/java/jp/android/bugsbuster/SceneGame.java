...
public class SceneGame  implements Scene {
	  ...
	  public final static int height = 790;//(int)GLESRenderer.SCREEN_HEIGHT*720/960;//*480/640;
	  ...
	  final static int paddingTop = 125;//120;//(int)GLESRenderer.SCREEN_HEIGHT*82/640;
	  final static int paddingBottom = (int) (GLESRenderer.SCREEN_HEIGHT-25);//(int) (GLESRenderer.SCREEN_HEIGHT-height-paddingTop);
	  final int Wave=30;
	  ...
	  //�`�揇
	  PImage game_bg = new PImage(Object.LAYER_0);
	  ...
	  Obstacle obstacleSet =  new Obstacle();
			 ...
			 //����
		      ...
		      for(int i=0; i < MAX_CAKE; i++)
		      {
		    	  ...
		    	  cake[i].init(((int)(GLESRenderer.SCREEN_WIDTH)-(int)(48*(MAX_CAKE+0.5-(i)))),
		    			  		paddingBottom,//(int)(GLESRenderer.SCREEN_HEIGHT-(msh*3.5)),
		    			  		48,
		    			  		48, 
		    			  		4, 4, 16, 0);
			  ...
			  play_img.init((int)(48*0.5f),paddingBottom,48,48);
			  play_img.setIdleColor(255, 255, 255, 255);
			  pause_img.init((int)(48*0.5f),paddingBottom,48,48);
		...
		public void update()
		{
			...
			//DEBUG
		  /*  
			//mWord.print("CAKE:"+cakeHP[0]+" "+cakeHP[1]+" "+cakeHP[2]+" "+cakeHP[3]+" "+cakeHP[4]+" ", (int)GLESRenderer.SCREEN_WIDTH/2, 9*(int)GLESRenderer.SCREEN_HEIGHT/10);
			mWord.print("Y:"+(int)enemy[0].getY()+" "+
					(int)enemy[1].getY()+" "+
					(int)enemy[2].getY()+" "+
					(int)enemy[3].getY()+" "+
					(int)enemy[4].getY()+" "+
					(int)enemy[5].getY()+" "+
					 ...
					 (int)enemy[8].getY()+" "+
					 (int)enemy[9].getY()+" ", 
					 (int)GLESRenderer.SCREEN_WIDTH/2, 9*(int)GLESRenderer.SCREEN_HEIGHT/10);
			 */
		...
		void mouseCalled(){
		  ...
		  void drawObje(int x,int y){
			  //����
			  circle_img.addPosition(x*msw+msw/2,y*msh+msh/2+paddingTop);
		  }
		  
		  void moveObje(int x,int y){
			  //����(��)
			  circle_img.addMovePosition(x*msw+msw/2,y*msh+msh/2+paddingTop);
		  }
		  
		  void drawObstacleObje(int x,int y){
			  //bridge
			  bridge_img.addPosition((x*msw)+(msw*(int)(obstacleRangeW/2)), (y*msh)+(msh*(int)(obstacleRangeH)));
			//  bridge_img.addPosition(x*msw-msw*(int)(obstacleRangeW/2)*9/10,
		  	//			 y*msh+msh*(int)(obstacleRangeH/2)*9/10);
		   //image(x*msw-msw*(int)(obstacleRangeW/2)*9/10,
			  //y*msh+msh*(int)(obstacleRangeH/2)*9/10,
			  //size
			  //msw*obstacleRangeW*9/10,msh*obstacleRangeH*9/10);
